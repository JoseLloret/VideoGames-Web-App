            ...
            <div className="container-GC">
                ...
                <div className="Conteiner2">
                    <div className="card-GC">
                        <img className="img-card" src={input.image && input.image ? input.image : ImgNotFound} alt='img not found' />
                        <h3 className="tit-card" style={{fontSize: 'x-large', textTransform: 'uppercase'}}>{input.name}</h3>
                        {/* <h4 className="info-card" style={{color: '#994caf', textTransform: 'uppercase', fontWeight: 'bold', textShadow: '0 0 3px #000000'}}>Descripcion:</h4>
                        <h5 className="info-card" >{input.description}</h5>
                        <h4 className="info-card" style={{color: '#994caf', textTransform: 'uppercase', fontWeight: 'bold', textShadow: '0 0 3px #000000'}}>Lanzamiento:</h4>
                        <h5 className="info-card">{input.released}</h5> */}
                        <h4 className="info-card" style={{color: '#994caf', textTransform: 'uppercase', fontWeight: 'bold', textShadow: '0 0 3px #000000'}}>Generos:</h4>
                        <h5 className="info-card">{input.genres.length > 1 ? input.genres.join(', '): input.genres}</h5>
                        <h4 className="info-card" style={{color: '#994caf', textTransform: 'uppercase', fontWeight: 'bold', textShadow: '0 0 3px #000000'}}>Rating:</h4>
                        <h5 className="info-card">★ {input.rating}</h5>                        
                        {/* <h4 className="info-card" style={{color: '#994caf', textTransform: 'uppercase', fontWeight: 'bold', textShadow: '0 0 3px #000000'}}>Plataforma:</h4>
                    ...
                    <div className="Formulario">
                        <form onSubmit={(e) => handleSubmit(e)}>
                            <div className="form">
                                ...
                                <div>
                                    <label>Genero: </label>
                                    <select style={{ width: '250px', textAlign: 'center' }} onChange={(e) => handleSelect(e)} >
                                        {genres.map((g) => (
                                ...
                                <div>
                                    ...
                                    <select style={{ width: '250px', textAlign: 'center' }} onChange={(e) => handleSelectPlatform(e)} >
                                        {platforms.map((p) => (
